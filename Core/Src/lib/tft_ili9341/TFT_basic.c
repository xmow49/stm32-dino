/**
 * @file	TFT_basic.c
 * @brief	d�finition des fonctions de dessin g�n�raliser
 * @author	Th�o GUILLEMAUD
 */
#include "lib/tft_ili9341/TFT_basic.h"
...
/***
 * @brief	trouve la droite o� ne passe pas le sommet
 */
...
/**
 * @brief	calcul le y pour un x et une droite donn�
 */
...
//			ASSERT_T(i == object->nb_points, "L'indice a d�pass� la taille du tableau de points d'objet");
			ILI9341_DrawLine(
